...
def main():
    ...
    #for idx, row in zip(A[0],A[1]):
    #    print idx, row
    #print key_mat, len(key_mat)
    ...
    for idx in range(13):
        plt.plot(normal_test_2dim[idx][0], normal_test_2dim[idx][1],'bo')
        #print normal_test_2dim[idx][0], normal_test_2dim[idx][1]

    for idx in range(13,71):
        plt.plot(normal_test_2dim[idx][0], normal_test_2dim[idx][1],'ro')
        #print normal_test_2dim[idx][0], normal_test_2dim[idx][1]
