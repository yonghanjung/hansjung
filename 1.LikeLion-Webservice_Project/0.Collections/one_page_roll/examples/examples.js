...
$(".third-description").click(function() {
	...
	$(".fourth-description").show()
});

$(".fourth-description").click(function(){
	$("#unfair").fadeIn()
});

$(".first-talk").click(function(){
	$(".first-talk").hide()
	$(".second-talk").show()
});

$("#fifth-page-talk").click(function(){
	$(this).hide();
	$("#structure").show();
});
...
$("#structure").click(function(){
	$(this).hide();
	$(".fifth-page-second").show();
});

$(".fifth-page-second").click(function(){
	$(".fifth-page-second").hide();
	$(".fifth-page-last").show();
});
